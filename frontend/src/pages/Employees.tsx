...
export default function Employees() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Employee List */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden text-black transition-all">
        {loading ? (
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm transition-all">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-300">
            <div className="px-6 py-5 bg-gray-50 border-b border-gray-100 flex justify-between items-center text-black">
              <div>
            ...
            <form onSubmit={handleCreateEmployee} className="p-6 space-y-4 text-black">
              <div>
